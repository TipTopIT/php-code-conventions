...
Этот документ содержит правила написания кода (Code Conventions) взят у [компании Roistat](http://roistat.com/ru/) и доработан [floor12](https://github.com/floor12/) для нужд компании [TipTopIT](https://tiptopit.ru/).
...
## **Работа со скриптами**
### 📖 Любой скрипт или консольная команда Yii2, который изменяет данные, должен иметь подтверждение перед выполнением действий с данными и `debug` по результатам работы
...
- Горяев Евгений ([Floor12](https://github.com/floor12))
